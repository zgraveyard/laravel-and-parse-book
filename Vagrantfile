Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "./www/laravel/app/storage", "/var/www/laravel.dev/app/storage", id: "vagrant-laravel-storage", :owner => 'www-data', :group => 'www-data'
  
  config.vm.synced_folder "./www/laravel", "/var/www/laravel.dev/", id: "vagrant-root" , :nfs => false
