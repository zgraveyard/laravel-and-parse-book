Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "./www/laravel/app/storage", "/var/www/laravel/app/storage", id: "vagrant-laravel-storage", :owner => 'www-data', :group => 'www-data'
  config.vm.synced_folder "./www", "/var/www", id: "vagrant-root", :nfs => false

  config.vm.usable_port_range = (2200..2250)
  config.vm.provider :virtualbox do |virtualbox|
    virtualbox.customize ["modifyvm", :id, "--name", "jasmine-vm"]
